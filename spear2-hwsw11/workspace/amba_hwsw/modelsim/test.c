...
//static module_handle_t counterHandle2;
...
int main(int argc, char **argv)
{
  ...
  //counter_initHandle(&counterHandle2, COUNTER_BADDR);
  counter_setPrescaler(&counterHandle, 3);
  //counter_setPrescaler(&counterHandle2, 3);
  // UART
  cfg.fclk = 50000000;
  ...
  //counter_releaseHandle(&counterHandle2);
...
//   }
  ...
  tgaHeader[2]  = 2;       // image type = uncompressed
  tgaHeader[16] = 24;
  ...
  //cycles = counter_getValue(&counterHandle2);
  //UART_write(1, (char *)&cycles, sizeof(cycles));
