...
add wave /top_tb_kamera/start_conv_sig


add wave /top_tb_kamera/read_kamera1/r
add wave /top_tb_kamera/read_kamera1/r_next

add wave /top_tb_kamera/conv1/r
add wave /top_tb_kamera/conv1/r_next

add wave /top_tb_kamera/tp_ram1/*
add wave /top_tb_kamera/dp_ram1/*

#add wave /top_tb_kamera/conv1/*
